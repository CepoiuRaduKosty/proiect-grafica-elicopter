...
void CALLBACK godown() {
	zheli--;
	if (zheli < -20) zheli = -20;
}
...
void myInit()
{
	...
	textureId1 = incarcaTextura("camo.bmp");
...
int main(int argc, char** argv)
{
	...
	auxKeyFunc(AUX_UP, goup);
	auxKeyFunc(AUX_DOWN, godown);
